...
A basic multilayer perceptron (MLP) neural network used to classify labels using biological features such as gene expression or genotypes. Useful for Gene Expression Matrices (GEM) and other data in matrix form.
...
1. Process discrete data
   - DNA data
1. Ability to save and load the trained model
